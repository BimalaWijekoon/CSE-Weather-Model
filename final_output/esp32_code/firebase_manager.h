...
// Optional: Firebase Authentication (for secure access)
...
#define BACKUP_INTERVAL 15000                 // Backup every 30 seconds for testing (was 300000 = 5 min)
...
public:
    ...
    void initialize() {
        ...
        // Optional: Use authentication for secure access
        #ifdef FIREBASE_USER_EMAIL
